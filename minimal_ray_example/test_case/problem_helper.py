...
class TestFlowReference(FLSpec):
    ...
    def start(self):
        ...
        print("********************* DEBUG *********************")
        print(f" Flow start - step_one_collab_attrs: {TestFlowReference.step_one_collab_attrs}")
        print(f" Flow start - TestFlowReference: {id(TestFlowReference)}")
    ...
    def test_create_collab_attr(self):
        ...
        print("********************* DEBUG test_create_collab_attr *********************")
        print(f" Flow test_create_collab_attr - step_one_collab_attrs: {TestFlowReference.step_one_collab_attrs}")
        print(f" Flow test_create_collab_attr - TestFlowReference: {id(TestFlowReference)}")

        print("******************************* DEBUG test_create_collab_attr ********************************")
        for collab in TestFlowReference.step_one_collab_attrs:
            print(f"*************** Collab name: {collab.input} ******************")
...
def run():
    ...
    collaborator_names = ["col0", "col1", "col2", "col3"]
    ...
    for i in range(2):
        ...
        testflow.run()
        testflow.step_one_collab_attrs = []
