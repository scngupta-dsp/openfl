...
def run_experiment():
    ...
    for idx, collaborator in enumerate(collaborators):
        ...
        local_train.data = mnist_train.data[idx :: n_shards]
        local_train.targets = mnist_train.targets[idx :: n_shards]
        local_test.data = mnist_test.data[idx :: n_shards]
        local_test.targets = mnist_test.targets[idx :: n_shards]
